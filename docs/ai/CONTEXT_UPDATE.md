...
- API origin resolution uses `NEXT_PUBLIC_API_URL`; the shared API client appends `/v1` centrally.
...
- Production API currently targets a plain HTTP IP; final HTTPS domain is not confirmed.
